		  ...
		  <table class="table table-bordered mt-3">
			...
			<c:forEach items="${ pageData.content }" var="product">
				<tr>
						<td>${ product.id }</td>
						<td>${ product.name }</td>
						<td align="center" width="120"><img src="${ pageContext.request.contextPath }/views/stogare/${product.image}" width="100" height="100"/></td>
						<td>${ product.price }</td>
		...
		<div>
			<ul class="pagination">
				<li class="page-item"><a class="page-link"
					href="${ pageContext.request.contextPath }/admin/product?limit=5&page=0">0</a>
				</li>
				<c:forEach begin="0" end="${ pageData.totalPages - 1 }"
					varStatus="page">

					<li class="page-item"><a class="page-link"
						href="${ pageContext.request.contextPath }/admin/product?limit=5&page=${ page.index + 1 }">${ page.index + 1 }</a>
					</li>
				</c:forEach>
			</ul>
		</div>
